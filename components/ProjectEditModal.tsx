        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 min-h-[250px] bg-muted border border-input rounded-lg text-foreground focus:outline-none focus:ring-2 focus:ring-primary resize-y"
          ...
          <div className="flex justify-between items-center pt-4 border-t border-border">
            <div>
              <button
                ...
                className={`px-4 py-2 ${project.is_archived ? 'bg-green-600 hover:bg-green-700 text-foreground' : 'border border-red-500 text-red-500 hover:bg-red-500 hover:text-foreground'} rounded-lg transition-colors`}
