        ...
        <div className="bg-card/60 border border-border rounded-2xl overflow-hidden flex flex-col max-h-[500px]">
            <div className="flex items-center justify-between px-5 py-4 border-b border-border bg-card/80">
                ...
                <button 
                    ...
                    disabled={curating}
                    className="p-1.5 rounded-md hover:bg-muted transition-colors text-muted-foreground hover:text-primary disabled:opacity-50"
                ...
                {news.length === 0 ? (
                    ...
                    news.map(item => (
                        <div key={item.id} className="bg-background/40 p-4 rounded-xl border border-border/50 hover:border-input transition-colors">
                            ...
                            <div className="text-sm text-muted-foreground prose prose-invert prose-sm max-w-none prose-p:leading-relaxed prose-a:text-primary hover:prose-a:text-blue-300 prose-ul:pl-4">
